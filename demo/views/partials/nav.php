<nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/demo/index.php" class="<?php echo $_SERVER['REQUEST_URI'] === '/demo/index.php' ? 'bg-gray-900 text-black' : 'text-gray-300' ?>rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
                <a href="/demo/about.php" class="<?php echo $_SERVER['REQUEST_URI'] === '/demo/about.php' ? 'bg-gray-900 text-black' : 'text-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</a>
                <a href="/demo/contact.php" class="<?php echo $_SERVER['REQUEST_URI'] === '/demo/contact.php' ? 'bg-gray-900 text-black' : 'text-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
                </div>
            </div>
            </div>
            <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
                ...
                -->
                <!-- <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-hidden hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" id="user-menu">
